          ...
          children: <Widget>[
            GestureDetector(
              ...
              child: Container(
                ...
                child: Card(color:Colors.pink[100],
                  child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: const [
                        Icon(Icons.add_box_outlined,size:48.0),
                        Text('Complaints Section',textAlign: TextAlign.center,)
                      ]),
                ),
              ),
            ),
              ...
              child: Container(
                ...
                child: Card(
                  ...
                  child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: const [
                        Icon(Icons.new_label,size: 48.0,),
                        Text('Make an announcement',textAlign: TextAlign.center,)
                      ]),
                ),
              ),
            ),
              ...
              child: Container(
                ...
                child: Card(color:Colors.pink[100],
                  child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: const [
                        Icon(Icons.add_moderator,size: 48.0,),
                        Text('Manage/ Add slots',textAlign: TextAlign.center,)
                      ]),
                ),
              ),
            ),
                ...
                child: Card(color:Colors.pink[100],
                  child: Column(
                      ...
                      children: const [
                        ...
                        Text('Update covid status',textAlign: TextAlign.center,)
                      ]),
                ),
              ),
            ),
                ...
                child: Card(color:Colors.pink[100],
                  child: Column(
                      ...
                      children: const [
                        ...
                        Text('Logout admin',textAlign: TextAlign.center,)
                      ]),
                ),
              ),
